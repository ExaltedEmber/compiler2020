...
var symbolicNames = [ null, "SEMI", "WHILE", "LP", "RP", "IF", "ELSE", "RETURN", 
                      "LBR", "RBR", "NUM", "WHITESPACE", "COMMENT" ];

var ruleNames =  [ "program", "stmts", "stmt", "loop", "cond", "braceblock", 
                   "return_stmt", "expr", "lambda" ];
...
gramParser.RBR = 9;
gramParser.NUM = 10;
gramParser.WHITESPACE = 11;
gramParser.COMMENT = 12;
...
gramParser.prototype.lambda = function() {
    ...
    this.enterRule(localctx, 16, gramParser.RULE_lambda);
    try {
        this.enterOuterAlt(localctx, 1);
