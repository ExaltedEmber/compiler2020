...
gramLexer.MULOP = 27;
gramLexer.MINUS = 28;
gramLexer.STRING_CONSTANT = 29;
gramLexer.ID = 30;
gramLexer.WHITESPACE = 31;
gramLexer.COMMENT = 32;
...
gramLexer.prototype.literalNames = [ null, "';'", "','", "'while'", "'print'", 
                                     ...
                                     "'close'", "'now'", null, null, null, 
                                     "'if'", "'else'", "'return'", null, 
                                     null, null, null, null, "'or'", "'and'", 
                                     "'not'" ];

gramLexer.prototype.symbolicNames = [ null, "SEMI", "COMMA", "WHILE", "PRINT", 
                                      "INPUT", "OPEN", "READ", "WRITE", 
                                      "CLOSE", "NOW", "LP", "RP", "EQ", 
...
gramLexer.prototype.ruleNames = [ "SEMI", "COMMA", "WHILE", "PRINT", "INPUT", 
                                  "OPEN", "READ", "WRITE", "CLOSE", "NOW", 
                                  "LP", "RP", "EQ", "IF", "ELSE", "RETURN", 
                                  "LBR", "RBR", "NUM", "FPNUM", "TYPE", 
                                  "OR", "AND", "NOT", "RELOP", "PLUS", "MULOP", 
                                  "MINUS", "STRING_CONSTANT", "ID", "WHITESPACE", 
                                  "COMMENT" ];
